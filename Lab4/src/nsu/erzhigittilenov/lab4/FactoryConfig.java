...
public class FactoryConfig {
    ...
    public FactoryConfig(String configName) {
        try (InputStream is = FactoryConfig.class.getClassLoader().getResourceAsStream("nsu/antonsokovnin/lab4/" + configName)) {
            if (is == null) {
    ...
    public void setEnginesStorageSize(int enginesStorageSize) {
        this.enginesStorageSize = enginesStorageSize;
    }
